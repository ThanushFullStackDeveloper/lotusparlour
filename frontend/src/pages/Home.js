...
const Home = () => {
  ...
  return (
    <div className="home-page">
      <OfflineBanner isOffline={isOffline} isStale={isStale} onRefresh={fetchData} />

      {/* HERO */}
      <section className="p-6">
        <h1 className="text-3xl font-bold">{settings.welcome_text}</h1>
        <p>{settings.parlour_name}</p>
      </section>
